...
pol(boris,m).
godine(boris,23).
tezina(boris,normalnaTezina).
pusac(boris,ne).
dijabeticar(boris,ne).
asmaticar(boris,ne).
fizickaAktivnost(boris,ne).
trudnoca(boris,ne).
alergican(boris,ne).
pritisak(boris,122,101).
auskultacija(boris,postojiSum).
porodicneBolesti(boris,[]).